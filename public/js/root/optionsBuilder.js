...
let meetingsTypes = [
    "Discovery", "Demo","Debrief","Follow-Up","Technical Deep Dive","Techical Help"
    ];
...
let sdrOptions = {};
let SDRs = [
    "Yves Régimbald", "Charles Kijek","Michael Badejo"
    ];
generateSelectOptions(SDRs,sdrOptions, "SRD");

let specialistsOptions = {};
let specialists = [
    "Mike Berthold", "Jordan Taylor","Alexander Spotnitz","Louis Migault"
    ];
...
let stageOptions = {};
let stages = [
    "No Stage", "Assigned","Discovery & Tech Qualification","Technical SCoping",
    "Validate Solution","Final Due","Technical Win","Technical Loss","Zombies"
    ];
...
let WIFs = [
    "UD", "MFA","AMFA","SS0","LCM","OIG","OAG","Workflows","ASA"
    ];
...
let presentationsAppOptions = {
    "name": "Application", "options": [{ "value": "app:ideal spaces sme", "text": "Ideal Spaces SME" },
...
let serviceStatusOptions = {
    ...
    "options": [{ "value": 3, "text": "Pipeline/SQL" }, { "value": 4, "text": "Pre Discovery" }, { "value": 5, "text": "Discovery" },
    { "value": 6, "text": "Brief" }, { "value": 7, "text": "Proposal" }, { "value": 8, "text": "Proposal Review" }, { "value": 9, "text": "Workshop" },
    { "value": 10, "text": "SOW" }, { "value": 11, "text": "Closed" }, { "value": 12, "text": "Lost to Competitor" }, { "value": 13, "text": "Won" },
...
let applicationOptions = {
    "name": "Applications", "options": [{ "value": 2, "text": "Ideal Spaces SME", "Abrev": "SME" }, { "value": 3, "text": "Mooble", "Abrev": "Mooble" },
    { "value": 4, "text": "Ideal Spaces Essentials Generic", "Abrev": "Ess Gen" }, { "value": 5, "text": "Ideal Spaces Essentials Imperial", "Abrev": "Ess Imp" },
    { "value": 6, "text": "Ideal Spaces Essentials Nobilia", "Abrev": "Ess Nobi" }, { "value": 7, "text": "Ideal Spaces Enterprise", "Abrev": "IS Ent" }
    ],
    select: function (onchange) {
